...
- Improved Ask and Search with query rewriting, reranking controls, source attribution, and tool-assisted answer generation.
...
- Documented the current beta setup, permissions, smoke-test flow, and V0 rollback path for release and support readiness.
- Remaining release gate: record fresh manual Chrome smoke evidence for Beta capture, search, Ask, and V0 rollback flows before publishing the final 0.2.0 package.
